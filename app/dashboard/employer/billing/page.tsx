import { CheckCircle2, Zap, Star, Shield, CreditCard, Download } from 'lucide-react';
        ...
        <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <div className="flex items-center gap-3 mb-1">
              <h3 className="text-xl font-bold text-slate-900">Стандартный тариф</h3>
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800">
                Активен
              </span>
            </div>
            <p className="text-sm text-slate-500">Следующий платеж: 15 Апреля 2026 (€149.00)</p>
          </div>
          <div className="flex items-center gap-8">
            <div className="text-right">
              <div className="text-2xl font-mono font-medium text-slate-900">3<span className="text-lg text-slate-400">/5</span></div>
              <div className="text-xs text-slate-500 uppercase tracking-wider mt-1">Активных вакансий</div>
            </div>
            <div className="w-px h-10 bg-slate-200"></div>
            <div className="text-right">
              <div className="text-2xl font-mono font-medium text-slate-900">12</div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 flex flex-col">
            ...
            <button className="w-full py-2 rounded-lg text-sm font-medium text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 transition-colors">
              Выбрать тариф
            </button>
          </div>

          {/* Pro (Popular) */}
          <div className="bg-white rounded-xl border-2 border-slate-900 p-6 flex flex-col relative">
            ...
            <button className="w-full py-2 rounded-lg text-sm font-medium text-white bg-slate-900 hover:bg-slate-800 transition-colors" disabled>
              Активен
            </button>
          </div>
