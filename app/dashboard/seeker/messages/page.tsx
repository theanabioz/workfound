          ...
          <div className="flex-1 overflow-y-auto">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-baseline mb-1">
                    <h3 className="font-bold text-slate-900 truncate">BuildEuro Sp. z o.o.</h3>
                    <span className="text-xs text-slate-400 font-medium">10:42</span>
                  </div>
                  <p className="text-sm text-slate-600 truncate">Здравствуйте, Алексей! Мы рассмотрели...</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border-b border-slate-100 hover:bg-white cursor-pointer transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-baseline mb-1">
                    <h3 className="font-bold text-slate-900 truncate">TransLogistics GmbH</h3>
                    <span className="text-xs text-slate-400 font-medium">Вчера</span>
                  </div>
                  <p className="text-sm text-slate-500 truncate">Ваше резюме получено.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="hidden md:flex flex-col flex-1 bg-white">
          ...
          <div className="h-16 border-b border-slate-100 px-6 flex items-center justify-between bg-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-slate-900">BuildEuro Sp. z o.o.</h2>
            ...
            <div className="flex gap-4 max-w-2xl">
              ...
              <div>
                <div className="bg-white border border-slate-200 p-4 rounded-2xl rounded-tl-none shadow-sm text-slate-700">
                  ...
                  <p className="mt-2">Мы рассмотрели ваше резюме на вакансию &quot;Строитель-универсал&quot;. Ваш опыт нам подходит. Готовы ли вы пройти небольшое собеседование по видеосвязи завтра в 14:00 по Варшаве?</p>
                </div>
                <div className="text-xs text-slate-400 mt-1.5 ml-1 font-medium">10:42</div>
              </div>
            </div>
            ...
            <div className="flex gap-4 max-w-2xl ml-auto flex-row-reverse">
              ...
              <div className="flex flex-col items-end">
                ...
                <div className="text-xs text-slate-400 mt-1.5 mr-1 font-medium flex items-center gap-1">
                  10:45 <CheckCircle2 className="w-3.5 h-3.5 text-blue-500" />
                </div>
              </div>
            </div>
          </div>
