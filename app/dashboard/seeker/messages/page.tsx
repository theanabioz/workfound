          ...
          <div className="flex-1 overflow-y-auto">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-baseline mb-0.5">
                    <h3 className="text-sm font-bold text-slate-900 truncate">BuildEuro Sp. z o.o.</h3>
                    <span className="text-[10px] text-slate-500 font-medium">10:42</span>
                  </div>
                  <p className="text-xs text-slate-600 truncate">Здравствуйте, Алексей! Мы рассмотрели...</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border-b border-slate-200 hover:bg-slate-50 cursor-pointer transition-colors bg-white">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-baseline mb-0.5">
                    <h3 className="text-sm font-medium text-slate-900 truncate">TransLogistics GmbH</h3>
                    <span className="text-[10px] text-slate-400 font-medium">Вчера</span>
                  </div>
                  <p className="text-xs text-slate-500 truncate">Ваше резюме получено.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="hidden md:flex flex-col flex-1 bg-white">
          ...
          <div className="h-16 border-b border-slate-200 px-6 flex items-center justify-between bg-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-sm font-bold text-slate-900">BuildEuro Sp. z o.o.</h2>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-50/50">
            ...
            <div className="flex gap-3 max-w-2xl">
              ...
              <div>
                ...
                <div className="text-[10px] text-slate-500 mt-1 ml-1 font-medium">10:42</div>
              </div>
            </div>
            ...
            <div className="flex gap-3 max-w-2xl ml-auto flex-row-reverse">
              ...
              <div className="flex flex-col items-end">
                ...
                <div className="text-[10px] text-slate-500 mt-1 mr-1 font-medium flex items-center gap-1">
                  10:45 <CheckCircle2 className="w-3 h-3 text-slate-400" />
                </div>
              </div>
            </div>
          </div>
